...
function boiler_scripts_styles() {
	...
	wp_enqueue_script( 'images-loaded', get_template_directory_uri() . '/js/lib/images-loaded.js', '20120206', true );

	wp_enqueue_script( 'rellax', get_template_directory_uri() . '/js/lib/rellax.js', '20120206', true );

	wp_enqueue_script( 'boiler-plugins', get_template_directory_uri() . '/js/plugins.js', array(), '20120206', true );

	wp_enqueue_script( 'masinry', get_template_directory_uri() . '/js/lib/masonry.js', '20120206', true );
